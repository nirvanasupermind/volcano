...
TachyonVal start = System.o->get("time")({System});
for(TachyonVal i = TachyonVal::make_num(0); ((i < TachyonVal::make_num(1e+06))).b; (i = (i + TachyonVal::make_num(1)))) {
TachyonVal::make_object({});
}
TachyonVal end = System.o->get("time")({System});
System.o->get("print")({System,(end - start)});
    return 0;
}