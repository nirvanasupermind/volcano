...
(*tachyon_internal::decode_func(print))({tachyon_internal::make_str(new std::string("Thread "))});
(*tachyon_internal::decode_func(println))({(*tachyon_internal::decode_func(tachyon_internal::get_prop(tachyon_internal::decode_obj(ThisThread),"getID")))({ThisThread})});
(*tachyon_internal::decode_func(println))({i});
(*tachyon_internal::decode_func(tachyon_internal::get_prop(tachyon_internal::decode_obj(ThisThread),"sleepFor")))({ThisThread,1000});
}}
}
...
(*tachyon_internal::decode_func(println))({(*tachyon_internal::decode_func(tachyon_internal::get_prop(tachyon_internal::decode_obj(ThisThread),"getID")))({ThisThread})});
(*tachyon_internal::decode_func(println))({i});
(*tachyon_internal::decode_func(tachyon_internal::get_prop(tachyon_internal::decode_obj(ThisThread),"sleepFor")))({ThisThread,990});
}}
}
return tachyon_internal::null;
}))});
