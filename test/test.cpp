...
(*tachyon_internal::decode_func(print))({tachyon_internal::get_prop(tachyon_internal::decode_obj(c),"real")});
(*tachyon_internal::decode_func(print))({tachyon_internal::get_prop(tachyon_internal::decode_obj(c),"imag")});
